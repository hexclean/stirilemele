...
var transporter = nodemailer.createTransport({
  service: "gmail",
  auth: {
    user: "stirilemele.ro@gmail.com",
    pass: "StirileMele2021!",
  },
});
//
    ...
    await User.findOne({ where: { email: req.body.email } })
      ...
      .then(async (result) => {
        ...
        var mailOptions = {
          ...
          to: req.body.email,
          subject: "Resetarea parola Știrilemele",
          ...
          <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
              <span class="preheader">ȘTIRILEMELE Salut, Pentru resetare parola, accesează link-ul de mai jos. Dacă nu ai inițiat tu aceasta cerere, te rugăm să ignori acest email.</span>
                    ...
                    <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                     ...
                     https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                          <tr>
                                            <td align="center">
                                              <a href="https://stirilemele.ro/autentificare/reset/${token}" class="f-fallback button button--green" target="_blank">Schimbați parola</a>
                                            </td>
                                          </tr>
                                        </table>
                                      </td>
                                  ...
                                  <p>Daca nu ai inițiat tu aceasta cerere, te rugăm să ignori acest email.</p>
                                  <p>știrilemele.ro</p>
                                </div>
                              </td>
                            </tr>
