...
var discoverSwiper = new Swiper(
  "#discover-swiper",
  Object.assign({}, swiperOptions, { width: 320 })
);
var discoverSwiper2 = new Swiper(
  "#discover-swiper2",
  Object.assign({}, swiperOptions, { width: 260 })
);
var discoverSwiper3 = new Swiper(
  "#discover-swiper3",
  Object.assign({}, swiperOptions, { width: 360 })
);

// Create the Related Posts slider on Single pages
$$(document).on("page:init", '.page[data-name="single"]', function (e) {
  var rpSwiper = new Swiper(
    e.detail.$el.find(".single-swiper"),
    Object.assign({}, swiperOptions, { width: 280 })
  );
});
...
$$(document).on("page:init", '.page[data-name="pull-to-refresh"]', function (
  e
) {
...
$$(document).on("page:init", '.page[data-name="infinite-scroll"]', function (
  e
) {
  var allowInfinite = true;
  ...
  buttons: [
    [
      ...
      },
      {
        ...
        onClick: function () {
          window.open(
            "https://www.facebook.com/sharer/sharer.php?u=http%3A//themeforest.net",
            "_blank"
          );
        },
      },
      {
        ...
        onClick: function () {
          window.open(
            "http://twitter.com/share?text=Welcome%20To%20Yui&url=http://themeforest.net&hashtags=template,mobile",
            "_blank"
          );
        },
      },
